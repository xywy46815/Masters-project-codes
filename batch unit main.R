...
lifetbl_both <- lifetbl_both[lifetbl_both$Year >=1950 & lifetbl_both$Year < 2020, ]
lifetbl_male <- lifetbl_male[lifetbl_male$Year >=1950 & lifetbl_male$Year < 2020, ]
lifetbl_female <- lifetbl_female[lifetbl_female$Year >=1950 & lifetbl_female$Year < 2020, ]
...
return(list(male_pvalue = OM_unitroottest_p.value_male, female_pvalue = OM_unitroottest_p.value_female , 
            both_pvalue = OM_unitroottest_p.value_both))
}
