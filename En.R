#SET PATH
setwd('C:/Users/taowu/Desktop/en')
...
lifetbl_both_Finland <- lifetbl_both_Finland[lifetbl_both_Finland$Year >= 1928 & lifetbl_both_Finland$Year < 2020, ]
...
#z_matrix
# 使用 cbind() 将它们按列绑定为矩阵
z_matrix <- cbind(z_Denmark_vector, z_Finland_vector, z_Sweden_vector)
